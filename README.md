...
|---|---|---|
| [👁️ Eye Gaze Detection](https://github.com/Vedagurram/Eye-gaze-detection) | Real-time gaze tracking system to detect stress, drowsiness & attention levels in workplace environments | Python · OpenCV · dlib · MySQL |
| [🎓 Academic DB Management](https://github.com/Vedagurram/Academic-database-management-system) | Centralised ADMS for universities — manages students, faculty, courses, attendance & grades | C# · SQL · HTML · JS |
| [🧠 ML Rehabilitation Model](https://github.com/Vedagurram/ML-model-for-Rehabilitation-Centre) | Machine learning model built to assist rehabilitation centre management and patient tracking | Python · scikit-learn |
| [🌐 HTML Portfolio](https://github.com/Vedagurram/HTML-portfolio) | Personal portfolio website built from scratch using HTML & CSS | HTML · CSS |
